            ...
            <div class="modal-body">
                <form id="penilaianForm" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="penilaian_presentasi" name="penilaian_presentasi" min="0" max="100" required>
                    </div>
                    <div class="mb-3">
                        <label for="penilaian_materi" class="form-label">Nilai Materi (0-100)</label>
                        <input type="number" class="form-control" id="penilaian_materi" name="penilaian_materi" min="0" max="100" required>
                    </div>
                    <div class="mb-3">
                        <label for="penilaian_diskusi" class="form-label">Nilai Diskusi (0-100)</label>
                        <input type="number" class="form-control" id="penilaian_diskusi" name="penilaian_diskusi" min="0" max="100" required>
                    </div>
                    <div class="mb-3">
